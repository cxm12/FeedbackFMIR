...
class DIV2K(data.Dataset):
    def __init__(self, args, name='CCPs', train=True, benchmark=False):
        ...
        self.dir_data = '/home/user2/dataset/microscope/CSB/DataSet/BioSR_WF_to_SIM/DL-SR-main/dataset/train/%s/my_training_data.npz' % args.data_test
        self.dir_demo = '/home/user2/dataset/microscope/CSB/DataSet/BioSR_WF_to_SIM/DL-SR-main/dataset/test/%s/LR/' % args.data_test
...
class Flourescenedenoise(data.Dataset):
    ...
    def _scandenoisenpy(self):
        hr = []
        lr = []
        datapath = '/home/user2/dataset/microscope/CSB/DataSet/'
...
class Flouresceneiso(data.Dataset):
    ...
    def _scanisonpy(self):
        ...
        datapath = '/home/user2/dataset/microscope/CSB/DataSet/Isotropic/'
        for i in self.iso:
    ...
    def _scaniso(self):
        ...
        lr = []
        for i in self.iso:
            self.dir_lr = '/home/user2/dataset/microscope/CSB/DataSet/Isotropic/%s/test_data/' % i
...
class Flouresceneproj(data.Dataset):
    ...
    def _scannpy(self):
        ...
        if mytraindata == 1:
            datapath = '/home/user2/dataset/microscope/CSB/my_training_data.npz'
            X, Y, _, _ = loadData(datapath, axes=None, validation_split=0.0)
        elif mytraindata == 2:
            datapath = '/home/user2/dataset/microscope/CSB/my_training_data.npz'
            datapath2 = '/home/user2/dataset/microscope/CSB/DataSet/%s/train_data/data_label.npz' % \
                        self.iso[0]
            ...
            datapath = '/home/user2/dataset/microscope/CSB/DataSet/%s/train_data/data_label.npz' % self.iso[0]
    ...
    def _scan(self, condition):
        ...
        lr = []
        for i in self.iso:
            self.dir_lr = '/home/user2/dataset/microscope/CSB/DataSet/%s/test_data/' % i
...
class FlouresceneVCD:
    def __init__(self, args, istrain=True, subtestset='to_predict'):
        self.path = '/home/user2/dataset/microscope/VCD/vcdnet/vcd-example-data/data/'
        self.istrain = istrain
        self.args = args
        ...
        if args.test_only:
            if subtestset == 'to_predict':
                ...
                self.nm_hr3d = sorted(glob.glob('/home/user2/dataset/microscope/VCD/vcdnet/results/VCD_tubulin/*.tif'))
        else:
